      ...
      <ScrollView>
        <Container style={{ backgroundColor: 'transparent', justifyContent: "center" }}>
          <View style={[stylesLogin.box, { marginTop: 0 }]}>
            <Image style={stylesLogin.img_logoUser} source={require('../../assets/images/userReg.png')} />
            <TouchableHighlight activeOpacity={1} underlayColor='#ecfcff' style={stylesRegister.goBack} onPress={() => navigation.goBack()}>
